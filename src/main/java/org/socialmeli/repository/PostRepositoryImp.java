...
public class PostRepositoryImp implements IRepository<Post> {
    ...
    public PostRepositoryImp(){
        ...
        Post post1 = new Post(1, vendorRepositoryImp.findAll().get(0).getUserId(), LocalDate.of(2023, 3, 20), product1, 1, 35.99);
        Post post2 = new Post(2, vendorRepositoryImp.findAll().get(0).getUserId(), LocalDate.of(2024, 2, 15), product2, 2, 79.99);
        Post post3 = new Post(3, vendorRepositoryImp.findAll().get(0).getUserId(), LocalDate.now(), product3, 1, 49.99);
